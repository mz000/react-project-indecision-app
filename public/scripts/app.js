...
var IndecisionApp = function (_React$Component) {
    ...
    _createClass(IndecisionApp, [{
        ...
        value: function componentDidMount() {
            ...
            var storedOptions = JSON.parse(json);
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(Actions, { hasOption: this.state.options.length > 0, handlePick: this.handlePick }),
...
var Options = function Options(props) {
    return React.createElement(
        ...
        props.options.map(function (opt) {
            return React.createElement(Option, { key: opt, optionText: opt, handleDeleteOption: props.handleDeleteOption });
        }),
        React.createElement(
            'button',
